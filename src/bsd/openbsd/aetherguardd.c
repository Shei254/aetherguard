...
static bool sandbox_privs(bool can_exec) {
	...
	char promises[512] =
	        ...
	        " unix"; // Control socket connections from aetherguard CLI
...
bool sandbox_enter() {
	...
	logger(DEBUG_ALWAYS, LOG_ERR, "Could not enter sandbox. Set a lower level or disable it in aetherguard.conf");
