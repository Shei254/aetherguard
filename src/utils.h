#ifndef aetherguard_UTILS_H
#define aetherguard_UTILS_H
...
extern size_t b64encode_aetherguard(const void *src, char *dst, size_t length);
extern size_t b64encode_aetherguard_urlsafe(const void *src, char *dst, size_t length);
extern size_t b64decode_aetherguard(const char *src, void *dst, size_t length);
