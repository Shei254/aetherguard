/*
    top.c -- Show real-time statistics from a running aetherguardd
    Copyright (C) 2011-2013 Guus Sliepen <guus@aetherguard-vpn.org>
...
static void redraw(void) {
	...
	mvprintw(0, 0, "aetherguard %-16s  Nodes: %4d  Sort: %-10s  %s", netname ? netname : "", node_list.count, sortname[sortmode], cumulative ? "Cumulative" : "Current");
	attrset(A_REVERSE);
