#ifndef aetherguard_LOGGER_H
#define aetherguard_LOGGER_H
...
typedef enum debug_t {
	DEBUG_UNSET = -1,               /* Used by aetherguard as the default debug level. */
	DEBUG_NOTHING = 0,              /* Quiet mode, only show starting/stopping of the daemon */
	DEBUG_ALWAYS = 0,
	DEBUG_CONNECTIONS = 1,          /* Show (dis)connects of other aetherguard daemons via TCP */
