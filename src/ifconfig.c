/*
    ...
    Copyright (C) 2016-2018 Guus Sliepen <guus@aetherguard-vpn.org>
...
#endif
		        "\n"
		        "echo \"Unconfigured aetherguard-up script, please edit '$0'!\" >&2\n");
		return false;
	} else {
#ifndef HAVE_LINUX
...
void ifconfig_dhcp6(FILE *out) {
	(void)out;
	fprintf(stderr, "DHCPv6 requested, but not supported by aetherguard on this platform\n");
}
