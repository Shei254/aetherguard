...
static void test_device_enable_calls_aetherguard_up(void **state) {
	(void)state;

	run_device_enable_disable(&device_enable, "aetherguard-up");
}

static void test_device_disable_calls_aetherguard_down(void **state) {
	(void)state;

	run_device_enable_disable(&device_disable, "aetherguard-down");
}

int main(void) {
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_device_enable_calls_aetherguard_up),
		cmocka_unit_test(test_device_disable_calls_aetherguard_down),
	};
