...
def configure_nodes(ctx: Test) -> T.Tuple[aetherguard, aetherguard]:
...
def test_version(foo: aetherguard) -> None:
    ...
    check.has_prefix(out, "aetherguard version ")


def test_help(foo: aetherguard) -> None:
    """Test command 'help'."""
...
def test_info(foo: aetherguard, bar: aetherguard) -> None:
    """Test command 'info'."""
...
def test_pid(foo: aetherguard) -> None:
    """Test command 'pid'."""
...
def test_debug(foo: aetherguard) -> None:
    """Test command 'debug'."""
...
def test_log(foo: aetherguard) -> None:
    """Test command 'log'."""
    ...
    log_client = foo.aetherguard("log")
...
def test_restart(foo: aetherguard) -> None:
...
def test_shell(foo: aetherguard) -> None:
    """Test shell."""
