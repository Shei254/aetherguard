...
env = {
    ...
    "aetherguard_PATH": os.getenv("aetherguard_PATH"),
    "aetherguardD_PATH": os.getenv("aetherguardD_PATH"),
...
aetherguard_PATH = str(env["aetherguard_PATH"])
aetherguardD_PATH = str(env["aetherguardD_PATH"])
