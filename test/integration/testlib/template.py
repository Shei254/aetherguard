...
def make_cmd_wrap(script: str) -> str:
    """Create a .cmd wrapper for aetherguardd script. Only makes sense on Windows."""
    maps = {
...
def make_netns_config(namespace: str, ip_addr: str, mask: int) -> str:
    """Create a aetherguardd script that does network namespace configuration."""
