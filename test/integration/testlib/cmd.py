"""Wrappers for more complicated aetherguard/aetherguardd commands."""
...
def connect(node0: aetherguard, node1: aetherguard) -> ExchangeIO:
...
def exchange(node0: aetherguard, node1: aetherguard, export_all: bool = False) -> ExchangeIO:
...
def get(aetherguard: aetherguard, var: str) -> str:
    """Get the value of the variable, stripped of whitespace."""
    assert var
    stdout, _ = aetherguard.cmd("get", var)
    return stdout.strip()
