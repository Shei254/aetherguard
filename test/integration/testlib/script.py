"""Classes related to creation and control of aetherguardd scripts."""
...
class Script(Enum):
    """A list of supported aetherguardd scripts.
    hosts/XXX-{up,down} are missing because we generate node names at runtime.
    """

    aetherguard_UP = "aetherguard-up"
    aetherguard_DOWN = "aetherguard-down"
    HOST_UP = "host-up"
    HOST_DOWN = "host-down"
    SUBNET_UP = "subnet-up"
...
class aetherguardScript:
    """Control created aetherguardd scripts and receive notifications from them."""
