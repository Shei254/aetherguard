...
"""Test splicing connection between aetherguard peers."""
...
def init(ctx: Test, *options: str) -> T.Tuple[aetherguard, aetherguard]:
...
def splice(foo: aetherguard, bar: aetherguard, protocol: str) -> subp.Popen:
