...
def run_offline_tests(command: str, foo: aetherguard) -> None:
    """Run offline tests."""
...
def dump_pending_invitation(foo: aetherguard, bar: aetherguard) -> None:
...
def run_unconnected_tests(foo: aetherguard, bar: aetherguard) -> None:
...
def run_connected_tests(foo: aetherguard, bar: aetherguard) -> None:
